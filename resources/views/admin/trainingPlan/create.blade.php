	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Agregar Plan de Entrenamiento</a>
			</div>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="content table-responsive table-full-width">
                            <form action="/admin/trainingPlan/store" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="row">
								...
								<div class="row">
									...
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control border-input" name="price" id="price" required="required">
									</div>
                                </div>
                                <div class="row">
									<div class="col-md-4"></div>
									<div class="form-group col-md-4">
										...
										<input type="text" class="form-control border-input" name="discount" id="discount">
									</div>
                                </div>
                                <div class="row">
									<div class="col-md-4"></div>
                                ...
                                <div class="row">
									...
									<div class="form-group col-md-4">
										...
										<textarea rows="5" class="form-control border-input" name="short_description" id="short_description" required="required"></textarea>
									</div>
								</div>
								<div class="center">
